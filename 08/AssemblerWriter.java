...
public class AssemblerWriter {
	...
	public void writeArithmetic(String arithCommand) throws IOException, TypeNotPresentException {
		...
		switch (arithCmdSorter(arithCommand)) {
			...
			case EQ:
				myWriter.write("@SP\nA=M-1\nD=M\n@R13\nM=D\nA=A-1\n");
				myWriter.write("@2ndArgNeg_" + count + "\n");
				myWriter.write("D;JLT\n");
				// if we didn't jump - second arg (topmost of stack) is not negative.
				myWriter.write("@SP\n");
				myWriter.write("M=M-1\n");
				myWriter.write("A=M\n");
				myWriter.write("D=M\n");
				myWriter.write("// HERE IS THE @NOT_EQUAL_COUNT !!\n");
				myWriter.write("@NOT_EQUAL_" + count + "\n");
				myWriter.write("D;JLT\n");
				myWriter.write("@R13\n"); // I think this line is essential
				...
				myWriter.write("A=M\n");
				myWriter.write("D=M\n");
				myWriter.write("@NOT_EQUAL_" + count + "\n"); // 1st arg is Pos, 2nd arg is Neg
				myWriter.write("D;JLT\n"); // line 65
				myWriter.write("@R13\n"); // I think this line is essential
				myWriter.write("D=D-M\n");
				myWriter.write("@SP\n");
				myWriter.write("M=M-1\n");
				myWriter.write("@EQUAL_" + count + "\n");
